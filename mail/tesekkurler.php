...
$Mesaj = "
    ...
    Bu form Lawaga Alaçatı sayfasından geldi.
    ";
...
function mailgonder(){
         ...
         $mail->FromName = "Lawaga Alaçatı Web Sitesi";  
         ...
         $mail->Body = "<ul><li style='background-color:#e5e8e7;width:200px;padding:10px'>Adı Soyadı: ".$_POST['customerNameSurname'] . "</li>" .
...
<body class="home sky">
    ...
    width: 320px;
">
                        <img src="/assets/images/logo/mavi-alacati.png" alt="Jettel">
                    </div>
