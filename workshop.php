        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12 text-center">
                    <h2 class="page-title">Workshop</h2>
                ...
                <div class="col-xl-6 offset-xl-1">
                    <div class="about__right about__right--2 pl-45 pt-45">
                        <div class="section-heading section-heading__black">
                            ...
                            <h2 class="title mb-25">Lawaga Coffee Workshop</h2>
                            <p>Kahvesiz bir hayat sizin için mümkün değilse ve kahvenin her hâlini daha yakından tanıyarak iyi kahveyi bulmak için yola çıktıysanız, barista olmak istiyorsanız, Lawaga Coffee’nin kahve workshop'ları tam size göre.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-7 ">
                    <div class="about__right about__right--2  pt-45">
                        <div class="section-heading section-heading__black">
                            ...
                            <h2 class="title mb-25">Etkinliklere Katıl!</h2>
                            <p>Kahve hakkında daha çok bilgi sahibi olmak, farklı kahve demleme tekniklerini ve bu işin inceliklerini hem öğrenmek, hem de uygulamak istiyorsanız etkinliklerimize katılabilirsiniz.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-5 col-lg-7">
                    <div class="about__left about__left--2 position-relative">
                        <img  src="assets/images/workshop3.jpeg" alt="img">
    ...
    <section class="about__area about__area--2 grey-bg position-relative pt-120 pb-130">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-lg-7">
                    <div class="about__left about__left--2 position-relative">
                        <img  src="assets/images/workshop4.jpeg" alt="img">
                ...
                <div class="col-xl-6 offset-xl-1">
                    <div class="about__right about__right--2 pl-45 pt-45">
                        <div class="section-heading section-heading__black">
                            <!-- <span class="sub-title">HİKAYEMİZ</span> -->
                            <h2 class="title mb-25">Kahve Özeldir</h2>
                            <p>Her zaman kahvenin özel bir şey olması gerektiğine inandık ve bu basit düşünce bizi her gün daha akıllı kaynaklara, daha iyi kavurmaya ve tekrar tekrar daha fazla insanı memnun etmeye yöneltiyor.  </p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <form method="POST" action="mail/mail.php" >
                                        <div class="row">
                                            ...
                                            <input style="display: none;" value="Workshop" name="sayfa" type="text">
